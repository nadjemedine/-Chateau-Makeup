import { Product, Category, Brand, Review } from './supabase'
...
export const products: Product[] = [
  {
    id: 'p1',
    name: 'Aurora Noir Eau de Parfum',
    brand: 'Chateau',
    category: 'parfums',
  ...
  {
    id: 'p13',
    name: 'Huile Reparatrice Cheveux',
    brand: 'Chateau',
    category: 'cheveux',
    subcategory: 'hair-oil',
    price: 45,
  ...
  {
    id: 'p15',
    name: 'Creme Corps Karite',
    brand: 'Chateau',
    category: 'corps-et-bain',
...
export const reviews: Review[] = [
  {
    ...
    name: 'Sarah M.',
    rating: 5,
    comment: 'Un parfum absolument divin! Tient toute la journee et je recois toujours des compliments. Le flacon est tellement elegant.',
  ...
  },
  {
    ...
    name: 'Amelia K.',
    rating: 4,
    comment: 'Belle fragrance, tres feminine et sophistiquee. Vaut chaque dinar.',
  ...
  },
  {
    ...
    name: 'Jessica L.',
    rating: 5,
    comment: 'Mon parfum signature! Je le porte depuis des annees et je l\'adore toujours.',
  ...
  },
  {
    ...
    name: 'Michael T.',
    rating: 5,
    comment: 'Le meilleur parfum homme sans conteste. Frais mais masculin, parfait pour toute occasion.',
    created_at: '2024-03-01',
  },
  {
    id: 'r5',
    ...
    name: 'David R.',
    rating: 4,
    comment: 'Bonne tenue et projection. L\'ambroxan ressort vraiment.',
...
export const heroBanners = [
  {
    ...
    subtitle: 'Decouvrez les nouveaux parfums de la saison',
    cta: 'Decouvrir',
    image: '/hero1.jpg',
    color: '#1a1a1a',
  },
  {
    ...
    subtitle: 'Les tendances maquillage du printemps',
    cta: 'Acheter',
    image: '/hero2.jpg',
    color: '#2d2d2d',
  },
  {
    id: 'b3',
    title: 'Soins Visage',
    subtitle: 'Routine beaute pour une peau parfaite',
    cta: 'Explorer',
    image: '/hero3.jpg',
    color: '#1a1a1a',
  },
...
export const promoBanners = [
  {
    ...
    subtitle: 'Des 50 TND d\'achat',
    image: '/gift1.jpg',
  },
  {
    id: 'pb2',
    title: 'CADEAU OFFERT',
    subtitle: 'Pour tout achat de parfum',
    image: '/perfume1.jpg',
  },
]
