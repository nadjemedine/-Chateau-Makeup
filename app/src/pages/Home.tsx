...
export default function Home() {
  const featured = products.filter((p) => p.badge === 'HIT' || p.badge === 'DEAL').slice(0, 8)
  ...
  return (
    <div>
      <HeroBanner />
      <BrandCircles />
      <ProductSection title="Les marques recommandent" products={featured} />
      <PromoBanners />
      {newArrivals.length > 0 && <ProductSection title="Nouveautes" products={newArrivals} />}
